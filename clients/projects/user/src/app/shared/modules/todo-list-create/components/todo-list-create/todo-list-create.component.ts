...
import { SnTodoListFormComponent } from '../todo-list-form/todo-list-form.component';
...
import { buildTodoListFormGroup } from '../todo-list-form/todo-list-form.builder';
...
export class SnTodoListCreateComponent implements OnInit, AfterViewInit {
  @ViewChild(SnTodoListFormComponent, { static: true })
  public todoListForm: SnTodoListFormComponent;
