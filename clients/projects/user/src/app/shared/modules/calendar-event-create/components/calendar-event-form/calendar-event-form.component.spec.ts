...
import { SnCalendarEventFormComponent } from './calendar-event-form.component';

describe('SnCalendarEventFormComponent', () => {
  let component: SnCalendarEventFormComponent;
  let fixture: ComponentFixture<SnCalendarEventFormComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SnCalendarEventFormComponent);
