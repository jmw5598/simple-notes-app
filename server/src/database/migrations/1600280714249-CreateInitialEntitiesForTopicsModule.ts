...
export class CreateInitialEntitiesForTopicsModule1600280714249 implements MigrationInterface {
    name = 'CreateInitialEntitiesForTopicsModule1600280714249'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "topic_category" ("topicId" integer NOT NULL, "categoryId" integer NOT NULL, CONSTRAINT "PK_cf3189cfb3433ba594ff7106ac6" PRIMARY KEY ("topicId", "categoryId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_050fb7fcabbd109227be88766b" ON "topic_category" ("topicId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0f9130851d3da68df3569dc4dc" ON "topic_category" ("categoryId") `);
        ...
        await queryRunner.query(`ALTER TABLE "topic_category" ADD CONSTRAINT "FK_050fb7fcabbd109227be88766b4" FOREIGN KEY ("topicId") REFERENCES "topic"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "topic_category" ADD CONSTRAINT "FK_0f9130851d3da68df3569dc4dc3" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
